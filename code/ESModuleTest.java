...
public class ESModuleTest {
    ...
    /**
     * Test for module blocks. TODO
     */
    @Test
    public void testModuleBlock() throws IOException {
        File[] allFilesArray = null;
        try (Context context = JSTest.newContextBuilder().allowIO(true).build()) {
            allFilesArray = prepareTestFileAndModules("resources/moduleblocktest.js", "resources" +
